...
--[[ vim.api.nvim_set_hl(0, "SignColumn", { bg = colors.none, fg = colors.dark.other })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn", { bg = colors.none, fg = colors.orange.soft })
...
-- WarningMsg
vim.api.nvim_set_hl(0, "WarningMsg", { https://open.spotify.com/collection/tracksbg = colors.dark.eerie, fg = colors.orange.chinese, bold = true })
